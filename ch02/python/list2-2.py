...
print assets_df.name.head()
print assets_df.os.head()

# add a new column
assets_df['ip'] = [ "192.168.1.5","10.2.7.5","192.168.1.7","10.2.7.6", 
    "10.2.7.7" ]

# show only nodes with more than one high vulnerability
print assets_df[assets_df.highvulns>1].head()
